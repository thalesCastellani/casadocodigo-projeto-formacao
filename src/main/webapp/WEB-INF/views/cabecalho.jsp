			...
			<div id="header-content">
				<nav id="main-nav" >
					...
					<security:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li><a href="${s:mvcUrl('PSC#consomeServico').build() }" rel="nofollow"><fmt:message key="menu.pedidos_produtos"/></a></li>
						<li><a href="${s:mvcUrl('UC#listar').build() }" rel="nofollow"><fmt:message key="menu.usuarios_lista"/></a></li>
					</security:authorize>
						<li>
