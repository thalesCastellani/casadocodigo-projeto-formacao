...
public class ProdutoDAO {
	...
	public List<Produto> findComData(Calendar dataLancamento) {
		return manager.createQuery(
				"select distinct(p) from Produto p join fetch p.precos precos where p.dataLancamento >= :dataLancamento",
